...
use think\Model;
class GeneralUserList extends Model
{
    public function userToken()
    {
        return $this->hasOne(GeneralUserToken::class);
    }
    public function userLogin()
    {
        return $this->hasOne(GeneralUserLogin::class,'uid');
    }
    public function userinfo()
    {
        return $this->hasOne(GeneralUserInfo::class,'user_id');
    }
    public function moneyLogs()
    {
        return $this->hasMany(GeneralUserMoneylog::class,'user_id');
    }
    // 定义全局的查询范围
